// Global utility class names for typography

export const h1ClassName =
  "text-[40px] leading-[52px] lg:text-[56px] lg:leading-[63px]";

export const h2ClassName =
  "text-[30px] lg:leading-[40px] lg:text-[40px] lg:leading-[48px] text-[#232518]";
