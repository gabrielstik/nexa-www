...
const VARIANT_TO_CLASSES = {
  primary:
    "text-geist-mono inline-flex items-center gap-2 rounded-md bg-[#F2F9BE] text-gray-900 px-5 py-3 font-medium hover:bg-[F2F9BE] transition-colors uppercase text-[12px]",
  secondary:
